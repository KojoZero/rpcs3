	...
	, m_emu_settings(std::move(emu_settings))
{
	...
	const auto apply_fsr_specific_options = [this]()
	{
		...
		const bool fsr_rcas_selected = static_cast<output_scaling_mode>(value) == output_scaling_mode::fsr || static_cast<output_scaling_mode>(value) == output_scaling_mode::bicubic_rcas;
